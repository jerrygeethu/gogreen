...
<div style="height:10px;" class="cl">&nbsp;</div>
	...
	<div style=" float:left; width:120px; padding-top:2px;">
	  <p><img src="<?php echo $base;?>images/img01.jpg" alt="project" width="108" height="81" /></p>
        &nbsp;&nbsp;&nbsp;Upload Image >>
  	</div>
...
<div style=" float:left; height:20px;  width:100px; padding-top:20px;">   Full Name: </div>
...
<div style=" float:left; width:10px; height:25px;"></div>
<div style=" float:left; height:20px;  width:100px;">Password: </div>
<div style=" float:left; height:20px;  width:250px;">    <input tabindex="7" style="width:250px; " type="password" name="fn" id="fn6" />  
</div>
<div class="cl"></div>
<div style=" float:left; width:10px; height:25px;"></div>
<div style=" float:left; height:20px;  width:100px;">Con. Password: </div>
<div style=" float:left; height:20px;  width:250px;">    <input tabindex="7" style="width:250px; " type="password" name="fn" id="fn6" />  
</div>
<div class="cl"></div>
...
<div class="style2" style="float:left"></div>
    ...
    <a href="#"><img src="<?php echo $base;?>images/but_discard.png" alt="dis" width="80" height="22" border="0" /></a>&nbsp;<a href="#">
    <img src="images/but_save.png" alt="print" width="80" height="22" border="0" /></a></div>
