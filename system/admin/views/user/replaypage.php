...
<form method="post"  id = "resendmail" name = "resendmail" action="#" enctype="multipart/form-data">
...
<div class="composebox">
	...
	<div class="composecontant">
     	...
     	<div  > <input tabindex = "8"type="file" name="userfile" size="20" value = "<?php echo $full_path;?>" /> </div>
