...
<form action="<?php echo $base;?>admin.php/activity/cropadd" method="post" enctype="multipart/form-data">
...
<div style=" float:left; height:20px;  width:250px; padding-top:20px;">    <input tabindex="1" style="width:177px;"  type="text" name="name" id="name" />  </div>
<div class="cl"></div> <br />
