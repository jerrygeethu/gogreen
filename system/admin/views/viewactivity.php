...
<div class="act_contara1"> 
	<form method="post" action="<?php echo $base;?>admin.php/activity/search">
		<div align="left" class="contentheader1"> Search area  <br /> 
			...
			<div style=" float:left; height:20px;  width:250px; margin-top:13px;">   
				<input tabindex="5" style="width:250px; " type="text" name="date" id="date" value="" readonly />  
			</div>
			...
			<div style=" float:left; height:20px;  width:250px;">   
				<select  style="width:252px;"  name="project" id="project" onchange="getplot(this.value);">
					...
					<?php foreach($project as $pr) {  ?>
						<option value="<?php echo $pr->projectid;?>" <?php if($pr->projectid==$this->input->post('project')){echo  "selected=\"selected\"";}?>><?php echo $pr->title;?></option>
					<?php } ?>
				</select>
			</div>
			<div class="cl"></div> <br />
			<div id="plotdiv" style="display:none;">
				...
				<div style=" float:left; height:20px;  width:250px;">  
					<select name="plot" id="plot" style="width:252px;"></select>  
				</div>
				<div class="cl"></div> <br />
			</div>
	...
	<div align="center">
		<a href="<?php echo $base;?>admin.php/activity/activityadd">
			<input type="submit" name="input3" id="input3" value="Add" class="input_box" style="float:right; margin-right:90px;"/>
		</a>
	</div>
