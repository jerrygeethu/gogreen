...
<form action="<?php echo $base;?>admin.php/plant/addplant" method="post" enctype="multipart/form-data">
...
<option value=<?php echo $cp->id;?>><?php echo $cp->crop;?></option>
...
<div style=" float:left; height:20px;  width:250px; padding-top:20px;">  
  <input tabindex="8" style="width:177px;" type="text" name="number" id="number" />
...
<div style=" float:left; height:20px;  width:250px; padding-top:20px;">  
  <input tabindex="8" style="width:177px;" type="text" name="date" id="date" /> <img src="<?php echo $base;?>images/calendar.png" onclick="displayDatePicker('date')" alt="calender" width="26" height="26" border="0" />
