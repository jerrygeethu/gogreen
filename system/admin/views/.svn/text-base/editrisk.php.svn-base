...
<div class="contentarea2">
 <?php foreach($list as $li)
  { } ?>
<form action="<?php echo $base;?>admin.php/risk/editrisk/<?php echo $li->riskid;?>" method="post" enctype="multipart/form-data">
...
<select tabindex="1" style="width:177px;"  type="text" name="project" id="project" onchange="getplot(this.value);">
<option value="">Select project</option>
<?php foreach($project as $pr) { ?>

<option value="<?php echo $pr->projectid;?>" <?php if($li->projectid==$pr->projectid) { echo "Selected";}?> ><?php echo $pr->title;?></option>
...
<option value="<?php echo $li->plotid;?>"><?php echo $li->plot;?></option>
...
<option value="<?php echo $li->cropid;?>"><?php echo $li->crop;?></option>
...
<div style=" float:left; height:20px;  width:303px;">
  ...
  <input type="hidden" name="oldphoto" id="oldphoto" value="<?php echo $li->image;?>" />
  
  <img src="<?php echo $base;?>/uploads/risk/<?php echo $li->image;?>" width="50" height="50"/>
</div> 
<div class="cl"></div> <br />
<div class="cl"></div> <br />
...
<input type="hidden" name="riskid" id="riskid" value="<?php echo $li->riskid;?>" />
    <input type="submit" name="editsubmit" id="editsubmit" value="Edit" class="input_box"/> &nbsp; &nbsp;
