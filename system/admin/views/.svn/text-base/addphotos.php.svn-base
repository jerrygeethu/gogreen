...
<form action="<?php echo $base;?>admin.php/gallery/addphotos" method="post" enctype="multipart/form-data">
...
<div class="floatleft" style="height:20px;  width:300px; margin-top:15px;">
 ...
 <input tabindex="2" style="width:170px; " type="text" name="name" id="name" /> <?php echo form_error('name'); ?> </div></div>
...
<label>
<textarea name="description"  id="description"  rows="7" cols="21" ></textarea><?php echo form_error('description'); ?>
</label>  </div>
<div class="cl"></div><br />
<div style=" float:left; width:10px; height:25px;"></div>
	<div  class="font"style=" float:left; height:20px;  width:113px;"> Upload image:</div>
...
</select><?php echo form_error('category'); ?>  </div>
<div class="cl"></div> <br />
